...
/***/ function(module, exports, __webpack_require__) {
	...
	var _book_list = __webpack_require__(201);

	var _book_list2 = _interopRequireDefault(_book_list);

	var _book_details = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // HOW TO CONNECT APP STATE TO CONTAINER: need the connect from the library React-Redux
	  ...
	  _createClass(BookList, [{
	    ...
	    value: function renderBookList() {
	      ...
	      return this.props.books.map(function (book) {
	        // HOW TO CONNECT APP STATE TO CONTAINER: How to use the state: as props
	        return _react2.default.createElement(
	          "li",
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "ul",
	        { className: "book-list col-md-6 list-group" },
	        this.renderBookList()
	      );
	    }
	  }]);
	...
	function mapStateToProps(state) {
	  // HOW TO CONNECT APP STATE TO CONTAINER: map the app level state to props
	  return {
	    books: state.books
	  };
	}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BookList); // HOW TO CONNECT APP STATE TO CONTAINER: export this smart component, AKA container
...
/***/ function(module, exports, __webpack_require__) {
	...
	// HOW TO CONNECT APP STATE TO CONTAINER: need the connect from the library React-Redux
	  ...
	  _createClass(BookDetails, [{
	    ...
	    value: function render() {
	      if (!this.props.book) {
	        return _react2.default.createElement(
	          "div",
	          { className: "book-details col-md-6" },
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          ", ",
	          this.props.book.numPages,
	          " pages"
	        ),
	        _react2.default.createElement("img", { className: "book-image", src: "images/" + this.props.book.imageName })
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(BookDetails); // HOW TO CONNECT APP STATE TO CONTAINER: export this smart component, AKA container
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  ...
	  return [{ title: "The Ruby Programming Language", numPages: 123, author: "David Flanagan", imageName: "The Ruby Programming Language.jpg" }, { title: "Da Vinci Code", numPages: 456, author: "Dan Brown", imageName: "Da Vinci Code.jpg" }, { title: "Smalltalk 80", numPages: 200, author: "Adele Goldberg", imageName: "Smalltalk 80.jpg" }, { title: "Object Oriented JavaScript", numPages: 300, author: " Stoyan Stefanov", imageName: "Object Oriented JavaScript.jpg" }];
	};
